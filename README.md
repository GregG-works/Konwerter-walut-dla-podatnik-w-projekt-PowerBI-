...
Projekt ma na celu usprawnienie rozliczeń podatkowych dla polskich podatników, którzy rozliczają przychody w walutach obcych (np. mających obowiązek wypełnienia PIT-38 i rozliczających się ze sprzedaży instrumentów finansowych u zagranicznego brokera) i muszą przeliczać je na złote (PLN) według kursu średniego ogłaszanego przez Narodowy Bank Polski z ostatniego dnia roboczego poprzedzającego dzień uzyskania przychodu/poniesienia kosztu. Szczegółowy opis dot. przeliczania walut obcych na złote w wymienionych przypadkach można znaleźć w Art. 11a Ustawy z dnia 26 lipca 1991 r. o podatku dochodowym od osób fizycznych (dokument dostępny na stronie Sejmu RP - [link](https://isap.sejm.gov.pl/isap.nsf/download.xsp/WDU19910800350/U/D19910350Lj.pdf)).
...
- piąta zawiera typ (np. K lub Buy dla kupna instrumentu, S lub Sell dla sprzedaży instrumentu; kolumna jest ważna, ponieważ dzięki niej można ustalić, które rodzaje transakcji będą do siebie dodawane; nie powinno się dodawać wartości transakcji kupna do wartości transakcji sprzedaży, jeśli obie wielkości są dodatnie (lub obie są ujemne)).
